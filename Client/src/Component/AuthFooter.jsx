                ...
                <div className="grid md:grid-cols-4 gap-8">
                    ...
                    <div className="md:col-span-2">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="font-bold text-xl">AI Resume Analyzer</span>
                        </div>
                        <p className="text-slate-400 text-sm mb-4">
                            Optimize your resume with AI-powered analysis and get hired faster.
                            ATS-friendly resume scoring and personalized improvement suggestions.
                        </p>
                    </div>
