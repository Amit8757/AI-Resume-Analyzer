...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center bg-gradient-to-b from-[#F7FAFF] to-white py-12">
        <div className="bg-white shadow-xl rounded-xl p-8 w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* ... form fields ... */}
            {/* Keeping the form fields as is, just focusing on the replacement instruction context */}
            {/* I will use a larger context for the replacement to ensure accuracy */}
          ...
          <div className="space-y-3">
            <a
              href="https://ai-resume-analyzer-8eki.onrender.com/api/oauth/google"
            ...
            <a
              href="https://ai-resume-analyzer-8eki.onrender.com/api/oauth/github"
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors"
            >
